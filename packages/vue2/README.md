...
<p align="center">
  ...
  <a href="https://www.npmjs.com/package/@wordsmith/vue2">
    <img src="https://img.shields.io/npm/v/@wordsmith/vue2.svg">
  </a>
...
```sh
npm install @wordsmith/native @wordsmith/vue2 --save
```
...
import { WordsmithVue } from '@wordsmith/vue2';

ws.init({
  token: '<token>',
});

Vue.use(WordsmithVue);
...
<script>
import { LanguagePicker } from '@wordsmith/vue2';
  export default {
    name: 'App',
    components: {
      LanguagePicker,
